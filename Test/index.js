...
window.setInterval(function() {
    ...
    if (JSONData.uploader.length > 0) {
        ...
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetComicInfo.php?id=" + JSONData.uploader[i].id, function(data, status) {
            if (status == "success") {
    ...
    if (JSONData.author.length > 0) {
        authorbusy = true;
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetAuthorInfo.php?id=" + JSONData.author[iauthor].id, function(data, status) {
            if (status == "success") {
                var comicInfo = JSON.parse(data);
    ...
    if (JSONData.doujin.length > 0) {
        doujinbusy = true;
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetDoujinInfo.php?id=" + JSONData.doujin[idoujin].id, function(data, status) {
            if (status == "success") {
                var comicInfo = JSON.parse(data);
    ...
    if (JSONData.group.length > 0) {
        groupbusy = true;
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetGroupInfo.php?id=" + JSONData.group[igroup].id, function(data, status) {
            if (status == "success") {
                var comicInfo = JSON.parse(data);
...
function addUsr() {
    ...
    if (value.includes("https://hentaivn.net/user-") || value.includes("https://hentaivn.net/forum/user-")) {
        ...
        tempUsrId = userid;
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetFullInfo.php?id=" + userid, function(data, status) {
            if (status == "success") {
...
function addAuthor() {
    ...
    if (!value.includes("https://") && value.length > 0) {
        ...
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetAuthorInfo.php?id=" + userid, function(data, status) {
            if (status == "success") {
...
function addDoujin() {
    ...
    if (!value.includes("https://") && value.length > 0) {
        var userid = value.replace(" ", "+");
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetDoujinInfo.php?id=" + userid, function(data, status) {
            if (status == "success") {
...
function addGroup() {
    ...
    if (!value.includes("https://") && value.length > 0) {
		...
		.replace(/đ/g, "d")
		.replace(/Đ/g, "D");
        $.get("http://kirarin2005.000webhostapp.com/HVNFollower/API/GetGroupInfo.php?id=" + userid, function(data, status) {
            if (status == "success") {
